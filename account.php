...
?>
                ...
                <h4 style='padding-top:15px'>Edit Data Account Anda</h4>
             ...
             <footer id="footer"> 
                <div class="text-center clearfix">
                    <p><small>&copy 2015</small>
                        <br /><br /> 
                        <a href="https://rajaphp.com" class="btn btn-xs btn-circle btn-twitter"><i class="fa fa-twitter"></i></a> 
                        <a href="https://rajaphp.com" class="btn btn-xs btn-circle btn-facebook"><i class="fa fa-facebook"></i></a> 
                        <a href="https://rajaphp.com" class="btn btn-xs btn-circle btn-gplus"><i class="fa fa-google-plus"></i></a> 
                    </p> 
                </div> 
            </footer>